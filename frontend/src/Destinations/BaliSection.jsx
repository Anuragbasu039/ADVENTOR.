...
const trips = [
    {
        id: 1,
        image: bali1,
        title: 'Bali with Adventure Activities',
    ...
    },
    {
        id: 2,
        image: bali2,
        title: 'Bali Beaches Tour',
        nights: '4 Nights 5 Days',
        price: '₹ 54500',
        oldPrice: '₹ 55000',
        description: 'Stay Travel Meal Beach Visits',
    },
    {
        id: 3,
        image: bali3,
        title: 'Bali Cultural Exploration',
        nights: '5 Nights 6 Days',
        price: '₹ 54500',
        oldPrice: '₹ 55000',
        description: 'Stay Travel Meal Cultural Sites',
    },
    {
        id: 4,
        image: bali4,
        title: 'Bali Nature & Wildlife',
        nights: '5 Nights 6 Days',
        price: '₹ 54500',
        oldPrice: '₹ 55000',
        description: 'Stay Travel Meal Nature Tours',
    },
];
        ...
        <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col md:flex-row p-4 space-y-6 md:space-y-0 md:space-x-8 max-w-7xl mx-auto w-full">
                ...
                <div className="w-full md:w-1/3">
                    <form className="bg-white p-6 rounded-lg shadow-md space-y-4 max-w-md" onSubmit={handleSubmit}>
