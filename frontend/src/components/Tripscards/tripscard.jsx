...
const destinations = [
    ...
    { name: "Malaysia", img: Malaysia, link: "/malaysia" },
    { name: "Singapore", img: Singapore, link: "/singapore" },
    { name: "Azerbaijan", img: Azerbaijan, link: "/azerbaijan" },
    { name: "Himachal Pradesh", img: HimachalPradesh, link: "/himachal" },
    { name: "Goa", img: Goa, link: "/goa" },
    { name: "Meghalaya", img: Meghalaya, link: "/meghalaya" },
    { name: "Andaman", img: Andaman, link: "/andaman" },
    { name: "Kashmir", img: Kashmir, link: "/kashmir" },
    { name: "Uttarakhand", img: Uttarakhand, link: "/uttarakhand" },
    { name: "Rajasthan", img: Rajasthan, link: "/rajasthan" },
    { name: "North East", img: NorthEast, link: "/northeast" },
    { name: "Kerala", img: Kerala, link: "/kerala" },
